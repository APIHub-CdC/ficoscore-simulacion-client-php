...
class FICOScoreApi
{
    ...
    public function getReporte($x_api_key, $body)
    {
        list($response) = $this->getReporteWithHttpInfo($x_api_key, $body);
        return $response;
    }
    ...
    public function getReporteAsync($x_api_key, $body)
    {
        return $this->getReporteAsyncWithHttpInfo($x_api_key, $body)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    protected function getReporteRequest($x_api_key, $body)
    {
